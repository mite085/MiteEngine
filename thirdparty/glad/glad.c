/*
    ...
    OpenGL loader generated by glad 0.1.36 on Fri Oct 10 20:15:45 2025.
...
PFNGLMULTIDRAWMESHTASKSINDIRECTEXTPROC glad_glMultiDrawMeshTasksIndirectEXT =
    NULL;
PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTEXTPROC
glad_glMultiDrawMeshTasksIndirectCountEXT = NULL;
...
static void load_GL_EXT_mesh_shader(GLADloadproc load) {
  ...
  glad_glDrawMeshTasksEXT =
      (PFNGLDRAWMESHTASKSEXTPROC)load("glDrawMeshTasksEXT");
  glad_glDrawMeshTasksIndirectEXT =
      (PFNGLDRAWMESHTASKSINDIRECTEXTPROC)load("glDrawMeshTasksIndirectEXT");
  glad_glMultiDrawMeshTasksIndirectEXT =
      (PFNGLMULTIDRAWMESHTASKSINDIRECTEXTPROC)load(
          "glMultiDrawMeshTasksIndirectEXT");
  glad_glMultiDrawMeshTasksIndirectCountEXT =
