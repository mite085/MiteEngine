...
LightComponent::LightComponent()
    : SnapshotComponentTraits(), m_Light(nullptr) {}
...
std::shared_ptr<Light> LightComponent::GetLight() const { return m_Light; }

bool LightComponent::HasLight() const { return m_Light != nullptr; }
...
// ==================== 快照接口实现 ====================
const Light &LightComponent::GetSnapshotData() const { return *m_Light; }
