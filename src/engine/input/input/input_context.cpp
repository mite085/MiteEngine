...
void InputContext::ProcessEvent(Event &e) {
  ...
  dispatcher.Dispatch<MouseButtonPressedEvent>(
      BIND_DISPATCH_FN(ProcessMouseButtonPressedEvent));
  dispatcher.Dispatch<MouseButtonReleasedEvent>(
      BIND_DISPATCH_FN(ProcessMouseButtonReleasedEvent));
  dispatcher.Dispatch<MouseScrollEvent>(
      BIND_DISPATCH_FN(ProcessMouseScrollEvent));
  dispatcher.Dispatch<KeyPressedEvent>(BIND_DISPATCH_FN(ProcessKeyPressdEvent));
  dispatcher.Dispatch<KeyReleasedEvent>(
      BIND_DISPATCH_FN(ProcessKeyReleasedEvent));
