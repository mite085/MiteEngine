...
class ModelLoadEvent : public Event {
 public:
  ModelLoadEvent(std::shared_ptr<ModelSourceData> source,
                 std::shared_ptr<ModelAsset> asset)
      : m_Source(source), m_Asset(asset) {}
  std::shared_ptr<ModelSourceData> GetModelSourceData() { return m_Source; }
  std::shared_ptr<ModelAsset> GetModelAsset() { return m_Asset; }
...
class MaterialLoadedEvent : public Event {
 public:
  ...
  const MaterialSourceData &GetSourceData() const { return m_SourceData; }
  std::shared_ptr<MaterialAsset> GetMaterialAsset() { return m_Asset; }
...
class TextureLoadEvent : public Event {
 public:
  TextureLoadEvent(std::shared_ptr<TextureSourceData> source,
      ...
      : m_Source(source), m_Asset(asset) {}
  std::shared_ptr<TextureSourceData> GetTextureSourceData() { return m_Source; }
  std::shared_ptr<TextureAsset> GetTextureAsset() { return m_Asset; }
...
class RuntimeTextureCreateEvent : public Event {
 public:
  ...
  std::function<void(TextureGPUHandle)> GetCallback() { return m_Callback; }
...
class RuntimeTextureDestroyRequestEvent : public Event {
 public:
  RuntimeTextureDestroyRequestEvent(TextureGPUHandle handle)
      : m_Handle(handle) {}
  TextureGPUHandle GetTextureGPUHandle() { return m_Handle; }
  EVENT_CLASS_CATEGORY(EVENT_CATEGORY_SCENE_CHANGE)
  Event *Clone() const override {
