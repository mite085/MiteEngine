...
class BoundingVolume {
 public:
   ...
   * @brief 与其他包围体相交测试
   */
  BoundingVolumeIntersection::IntersectionType Intersects(
 ...
 private:
  ...
  std::variant<BoundingVolumeAABB, BoundingVolumeSphere, BoundingVolumeOBB,
               BoundingVolumePlane>
      m_Volume;
  BoundingVolumeType m_Type =
      BoundingVolumeType::None;  // 默认包围盒类型为None不可用
  ...
  BoundingVolumeIntersection::IntersectionType IntersectsOBB(
  ...
  //  * @return 变换后的AABB
  //  */
  // static BoundingVolumeAABB TransformAABB(const BoundingVolumeAABB &original,
  ...
  //  */
  // static BoundingVolumeAABB MergeAABBs(const BoundingVolumeAABB &a, const
  ...
  //  * @return 是否在内部
  //  */
  // static bool PointInAABB(const glm::vec3 &point, const BoundingVolumeAABB
  // &aabb);
  ...
  //  * @return 是否相交
  //  */
  // static bool AABBIntersectsAABB(const BoundingVolumeAABB &a, const
  // BoundingVolumeAABB &b);
  ...
  //  * @return 是否相交
  //  */
  // static bool SphereIntersectsAABB(const BoundingVolumeSphere &sphere, const
  ...
  //  * @return 是否相交
  //  */
  // static bool SphereIntersectsSphere(const BoundingVolumeSphere &a, const
  // BoundingVolumeSphere &b);
  ...
  //  * @return 包含AABB的最小球
  //  */
  // static BoundingVolumeSphere CreateSphereFromAABB(const BoundingVolumeAABB
  // &aabb);
  ...
  //  * @return 变换后的球
  //  */
  // static BoundingVolumeSphere TransformSphere(const BoundingVolumeSphere
  ...
  //  * @return 变换后的OBB
  //  */
  // static BoundingVolumeOBB TransformOBB(const BoundingVolumeOBB &obb, const
  // glm::mat4 &transform);
