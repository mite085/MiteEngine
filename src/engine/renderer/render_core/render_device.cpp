...
RenderDevice::RenderDevice() {
  ...
  m_EventSubscriptions.SubscribeImmediate<ModelLoadEvent>(
      BIND_DISPATCH_FN(OnModelLoaded), EventPriority::Normal);
  m_EventSubscriptions.SubscribeImmediate<TextureLoadEvent>(
      BIND_DISPATCH_FN(OnTextureLoaded), EventPriority::Normal);
